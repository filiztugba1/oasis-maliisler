...
const DefinitiveRecords: React.FC = () => {
  ...
  const handleSubmit = (e:any) => {
    e.preventDefault();
      ...
      axios.post<DefinitiveRecordResponse>('http://api-oasis.localhost/maliisler/maliisler/definitive-records',formData).then((res)=>{
              // setLoading(false);
              if(res.status===200)
              {
  ...
  return (
    <>
      ...
      <PageTitle breadcrumbs={accountBreadCrumbs}>Kesin Kayıtlar</PageTitle>
      <div className='card mb-5 mb-xl-10'>
        <div className='card-header pt-9 pb-0'>
